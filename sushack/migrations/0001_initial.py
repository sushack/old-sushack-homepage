...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sushack_attendee', (
            ...
            ('project', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'sushack', ['Attendee'])

        # Adding model 'MailingListPerson'
        db.create_table(u'sushack_mailinglistperson', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'sushack', ['MailingListPerson'])


    def backwards(self, orm):
        # Deleting model 'Attendee'
        db.delete_table(u'sushack_attendee')

        # Deleting model 'MailingListPerson'
        db.delete_table(u'sushack_mailinglistperson')
